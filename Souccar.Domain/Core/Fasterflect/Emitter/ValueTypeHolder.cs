...
namespace Souccar.Core.Fasterflect.Emitter
{
    /// <summary>
    /// A wrapper for value type.  Must be used in order for Souccar.Core.Fasterflect to 
    ...
    internal class ValueTypeHolder
    {
        ...
        /// can then be used with Souccar.Core.Fasterflect.
        /// </summary>
