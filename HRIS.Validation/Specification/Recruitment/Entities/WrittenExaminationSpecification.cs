...
{
    public class WrittenExaminationSpecification : Validates<WrittenExamination>
    {
        public WrittenExaminationSpecification()
        {
            ...
            Check(x => x.Place)
                .Required()
                .Expect((writtenExamination, place) => place.IsTransient() == false, "")
