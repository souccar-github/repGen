...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <% foreach (var item in (IEnumerable<Knowledge>)ViewData["ValueObjectsList"])
       { %>
    <tr style="border-width: 11; border-color: Black; border-spacing: 11">
        <td style="width: 20%; vertical-align: top">
            ...
            <div class="display-field">
                <%: Html.TextBoxFor(model => item.Field, new { @readonly = true, @class = "SingleLine" })%>
            </div>
        </td>
        <td style="width: 20%; vertical-align: top">
            <div class="display-label">
        ...
        <td style="width: 20%; vertical-align: top">
            ...
            <div class="display-field">
                <%: Html.TextBoxFor(model => item.Weight, new { @readonly = true, @class = "SingleLine" })%>
            </div>
        </td>
        <td style="width: 20%; vertical-align: top">
            <div class="display-label">
        ...
        <td style="width: 20%; vertical-align: top">
            <% if (ViewData["CanUpdate"] != null && (bool)ViewData["CanUpdate"])
               {%>
            <%: Ajax.ActionLink(Resources.Shared.Buttons.Function.Edit, "JsonEdit", "Knowledge", new { Id = item.Id }, new AjaxOptions { OnComplete = "JsonEdit_OnComplete" })%>
            <% } %>
        </td>
    </tr>
    <% } %>
