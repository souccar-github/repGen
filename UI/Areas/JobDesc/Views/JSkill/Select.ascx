...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <% foreach (var item in (IEnumerable<JSkill>)ViewData["ValueObjectsList"])
       { %>
    <tr style="border-width: 11; border-color: Black; border-spacing: 11">
        <td style="width: 25%; vertical-align: top">
            ...
            <div class="display-field">
                <%: Html.DisplayTextFor(model => item.Type.Name)%>
            </div>
        </td>
        <td style="width: 25%; vertical-align: top">
            ...
            <div class="display-field">
                <%: Html.DisplayTextFor(model => item.Level.Name)%>
            </div>
        </td>
        <td style="width: 25%; vertical-align: top">
            <div class="display-label">
            ...
            <div class="display-field">
                <%: Html.DisplayTextFor(model => item.Weight)%>
            </div>
        </td>
        <td style="width: 25%; vertical-align: top">
            <div class="display-label">
        ...
        <td align="right">
            <% if (ViewData["CanUpdate"] != null && (bool)ViewData["CanUpdate"])
               {%>
            <%: Ajax.ActionLink(Resources.Shared.Buttons.Function.Edit, "JsonEdit", "JSkill", new { Id = item.Id }, new AjaxOptions { OnComplete = "JsonEdit_OnComplete" })%>
            <% } %>
        </td>
    </tr>
    <% } %>
