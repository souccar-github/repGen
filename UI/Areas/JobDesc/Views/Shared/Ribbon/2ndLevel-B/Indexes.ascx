                    ...
                    <td>
                        <div class="box" style="z-index: 1000">
                            <ul id="ldd_menu" class="ldd_menu">
                                <li><span><%: Resources.Areas.JobDesc.Views.Shared.Ribbon._2ndLevel_B.Indexes.Responsibility%></span>
                                    <div class="ldd_submenu" style="z-index: 1000">
                                        <%--<ul>
                                            <li class="ldd_heading"><%: Resources.Areas.JobDesc.Views.Shared.Ribbon._2ndLevel_B.Indexes.JobRole%></li>
                                            <li><a href="#">
                                                <%: Html.ActionLink(Resources.Shared.RibbonLinks.Add.AddBrowse, "Index", "JobRole", new { area = "OrganizationChart" }, null)%>
                                            </a></li>
                                        </ul>--%>
                                        <ul>
                                            <li class="ldd_heading"><%: Resources.Areas.JobDesc.Views.Shared.Ribbon._2ndLevel_B.Indexes.JobTitle%></li>
                                            <li><a href="#">
                                                <%: Html.ActionLink(Resources.Shared.RibbonLinks.Add.AddBrowse, "Index", "JobTitle", new { area = "OrganizationChart" }, null)%>
                                            </a></li>
                                        </ul>
                                        <ul>
                                            <li class="ldd_heading"><%: Resources.Areas.JobDesc.Views.Shared.Ribbon._2ndLevel_B.Indexes.Priority%></li>
                                            <li><a href="#">
                                ...
                                <li><span><%: Resources.Areas.JobDesc.Views.Shared.Ribbon._2ndLevel_B.Indexes.Role%></span>
                                    <div class="ldd_submenu" style="z-index: 1000">
                                        <ul>
                                            <li class="ldd_heading"><%: Resources.Areas.JobDesc.Views.Shared.Ribbon._2ndLevel_B.Indexes.Priority%></li>
                                            <li><a href="#">
