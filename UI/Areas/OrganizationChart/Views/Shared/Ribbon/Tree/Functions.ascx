                                ...
                                <li><span>
                                    ...
                                    <div class="ldd_submenu" style="z-index: 1000">
                                        <ul>
                                            ...
                                            <li><a href="javascript:TreeAddPosition();">
                                                <%:Resources.Shared.Buttons.Ribbon.AddBrowse%>
                                            </a></li>
                                        </ul>
                                        <ul>
...
<script type="text/javascript">
    ...
    function TreeAddPosition() {

        if ($("#SelectedNodeID").attr("value") == "0") {

            alert('<%:Resources.Areas.OrgChart.ValueObjects.Node.Messages.SelectNodeToProceedPosition %>');
            return;
        }

        if ($("#SelectedNodeCode").attr("value") == "0000") {
            alert('<%:Resources.Areas.OrgChart.ValueObjects.Node.Messages.RootNodeDoesNotHaveAnyPositions %>');
            return;
