                                            ...
                                            <li>
                                                <%
                                                    if (Session["CurrentSecondLevelRowId"] != null)
                                                    {
                                                        ...
                                                        {	
                                                %>
                                                <%: Html.ActionLink(Resources.Shared.Buttons.Ribbon.AddBrowse, "Index", "Grade", new { selectedTabOrder = 0 }, null)%>
                                                <%
                                                        }
                                                        else
                                                        {
                                                %>
                                                <%:String.Format(Resources.Shared.Messages.Ribbon.ChooseA,Resources.Areas.OrgChart.Views.Shared.Ribbon.Functions.Functions.GradeTitle)%>
                                                <%
                                                        }
                                                    }
                                                    else
                                            ...
                                            <li>
                                                <%
                                                    if (Session["CurrentSecondLevelRowId"] != null)
                                                    {
                                                        ...
                                                        {	
                                                %>
                                                <%: Html.ActionLink(Resources.Shared.Buttons.Ribbon.AddBrowse, "Index", "Grade", new { selectedTabOrder = 1 }, null)%>
                                                <%
                                                        }
                                                        else
                                                        {
                                            ...
                                            <li>
                                                <%
                                                    if (Session["CurrentSecondLevelRowId"] != null)
                                                    {
                                                        ...
                                                        {	
                                                %>
                                                <%: Html.ActionLink(Resources.Shared.Buttons.Ribbon.AddBrowse, "Index", "Grade", new { selectedTabOrder = 2 }, null)%>
                                                <%
                                                        }
                                                        else
                                                        {
                                            ...
                                            <li>
                                                <%
                                                    if (Session["CurrentSecondLevelRowId"] != null)
                                                    {
                                                        ...
                                                        {	
                                                %>
                                                <%: Html.ActionLink(Resources.Shared.Buttons.Ribbon.AddBrowse, "Index", "Grade", new { selectedTabOrder = 3 }, null)%>
                                                <%
                                                        }
                                                        else
                                                        {
                                            ...
                                            <li>
                                                <%
                                                    if (Session["CurrentSecondLevelRowId"] != null)
                                                    {
                                                        ...
                                                        {	
                                                %>
                                                <%: Html.ActionLink(Resources.Shared.Buttons.Ribbon.AddBrowse, "Index", "Grade", new { selectedTabOrder = 4 }, null)%>
                                                <%
                                                        }
                                                        else
                                                        {
                                ...
                                <li><span>
                                    ...
                                    <div class="ldd_submenu" style="z-index: 1000">
                                        <ul>
                                            ...
                                            <li><a href="#">
                                                <%: Html.ActionLink(Resources.Areas.OrgChart.Views.Shared.Ribbon.Functions.Functions.SelectNodeTitle, "Index", "OrganizationChart")%>
                                            </a></li>
                                        </ul>
                                        <ul>
                                            <li class="ldd_heading">
                                                <%:Resources.Areas.OrgChart.Views.Shared.Ribbon.Functions.Functions.GradeTitle %></li>
                                            <li><a href="#">
                                                <%: Html.ActionLink(Resources.Areas.OrgChart.Views.Shared.Ribbon.Functions.Functions.SelectPositionTitle, "Index", "OrganizationChart")%>
                                            </a></li>
                                        </ul>
                                        <ul>
                                            <li class="ldd_heading">
