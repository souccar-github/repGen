...
<div class="editor-label-required">
    <%: Html.Label(Resources.Areas.Services.ResourceEditor.ResourceEditorModel.SoftwareLanguageField)%>
</div>
<div class="editor-field">
    <%= Html.Telerik().ComboBox()
                ...
                .DataBinding(binding => binding.Ajax().Select("GetSoftwareLanguages", "ResourceEditor"))
