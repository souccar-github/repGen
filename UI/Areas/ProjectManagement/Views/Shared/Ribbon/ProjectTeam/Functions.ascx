                                ...
                                <li><span><%: Resources.Areas.ProjectManagment.Views.Shared.Ribbon.Functions.Functions.Project%></span>
                                    <div class="ldd_submenu" style="z-index: 1000">
                                        <ul>
                                            ...
                                            <li><a href="#">
                                                <%:Html.ActionLink(Resources.Shared.RibbonLinks.Add.AddBrowse, "Index", "Project",
                                            ...
                                            <li><a href="#">
                                                <%
                                                    if (Session["CurrentSecondLevelRowId"] != null)
                                                    {
                                                        ...
                                                        {%>
                                                <%:Html.ActionLink(Resources.Shared.RibbonLinks.Add.AddBrowse, 
                                                    "GoToProjectTeams", "Project", new { selectedTabOrder = 0, ribbon = false }, null)%>
                                                <%
                                                        }
                                                        else
                                                        {
                                            ...
                                            <li><a href="#">
                                                <%
                                                    if (Session["CurrentSecondLevelRowId"] != null)
                                                    {
                                                        if ((int)Session["CurrentSecondLevelRowId"] != 0 )
                                                        {%>
                                                <%:Html.ActionLink(Resources.Shared.RibbonLinks.Add.AddBrowse, "GoToProjectTeams", "Project", 
                                                    new { selectedTabOrder = 0, ribbon = false }, null)%>
                                                <%
                                                        }
                                                        else
                                                        {
                                            ...
                                            <li><a href="#">
                                                <%
                                                    if (Session["CurrentlyInFirstLevel"] != null)
                                                    {
                                                        if ((bool)Session["CurrentlyInFirstLevel"])
                                                        {%>
                                                <%:Html.ActionLink(Resources.Shared.RibbonLinks.Add.AddBrowse, "GoToProject", "Project", 
                                                    new { selectedTabOrder = 1, ribbonSubEntity = true }, null)%>
                                                <%
                                                        }
                                                        else
                                                        {
                                            ...
                                            <li><a href="#">
                                                <%
                                                    if (Session["CurrentSecondLevelRowId"] != null)
                                                    {
                                                        ...
                                                        {%>
                                                <%:Html.ActionLink(Resources.Shared.RibbonLinks.Add.AddBrowse, "GoToProjectPhases", "Project", 
                                                    new { selectedTabOrder = 0, ribbon = false }, null)%>
                                                <%
                                                        }
                                                        else
